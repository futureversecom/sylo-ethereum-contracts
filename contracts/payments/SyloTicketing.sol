...
contract SyloTicketing is ISyloTicketing, Initializable, Ownable2StepUpgradeable, ERC165 {
    ...
    function redeem(
        ...
        requireValidWinningTicket(ticket, redeemerRand, senderSig, receiverSig);
    ...
    function requireValidWinningMultiReceiverTicket(
        ...
        // actors, and is primarily used to validate all actors agreed
        // on the contents of the ticket.
